...
__decorate([
    (0, common_1.Post)(':workspaceId/create'),
...
__decorate([
    (0, common_1.Patch)(':workspaceId/update/:id'),
    __param(0, (0, common_1.Param)('workspaceId', common_1.ParseIntPipe)),
...
__decorate([
    (0, common_1.Delete)(':workspaceId/delete/:id'),
    __param(0, (0, common_1.Param)('workspaceId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':workspaceId/all'),
    __param(0, (0, common_1.Param)('workspaceId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
